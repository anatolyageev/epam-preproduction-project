...
public class Server extends Desktop{
     ...
     * @param isIpmi
     */
    public Server(Long id, Double price, String processorType, Double processorFrequency, Integer installedMemory, String formFactor, Integer cpuNumber, Boolean isIpmi) {
